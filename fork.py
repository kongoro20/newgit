...
verif_button_image = 'fork_button.png'
verif1_button_image = 'desktop_button.png'
...
for attempt in range(max_attempts):
    ...
    try:
        ...
        button_location = pyautogui.locateOnScreen(verif1_button_image, confidence=0.9)
    except Exception as e:
    ...
    pyautogui.press('up')  # Press the Down Arrow key
