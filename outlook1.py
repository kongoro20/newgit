...
def perform_actions():
    ...
    random_click_in_area((738, 336), (846, 346))
    time.sleep(random.uniform(1, 1.5))
    random_click_in_area((739, 364), (843, 370))
    time.sleep(random.uniform(0.5, 1))
    random_click_in_area((514, 337), (696, 342))
    time.sleep(random.uniform(0.5, 1))
    ...
    # Random click in specific area
    random_click_in_area((762, 463), (842, 477))
    ...
    # Random click in specific area
    random_click_in_area((764, 504), (846, 515))
    time.sleep(random.uniform(4, 5))
    pyautogui.click(647, 299)
    time.sleep(1)
    # Random click in specific area
    random_click_in_area((512, 394), (793, 399))
    time.sleep(random.uniform(1, 2))
    ...
    # Random click in specific area
    random_click_in_area((515, 447), (825, 453))
    time.sleep(random.uniform(1, 2))
    ...
    # Random click in specific area
    random_click_in_area((760, 501), (847, 516))
    time.sleep(random.uniform(4, 5))
